{
  "info": {
    ...
    "_postman_id": "70faeafe-7cbf-4bbf-a7b9-9b96c1586f35",
  ...
  "item": [
    {
      ...
      "item": [
        {
          "id": "652a29d3-027f-4581-9d80-a897cdd84466",
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "76f4be56-b690-4399-a97d-759b43f8827f"
            }
          ]
        }
      ]
    },
    {
      ...
      "item": [
        {
          "id": "a0b0d1d3-f7f4-4100-b697-72d8c1bc785c",
          "name": "AirQuality_Get",
          "request": {
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "117d45d4-18c0-4d5e-b424-7572a9ed72a2"
            }
          ]
        }
      ]
    },
    {
      ...
      "item": [
        {
          "id": "aabc2f00-641c-4cd4-ba74-23d8432a37b0",
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "15006cf7-ee57-4d0d-ba2d-11ddabb8c207"
            }
          ]
        },
        {
          "id": "b3d72224-d481-4829-be16-e9a3b28c7e6d",
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "519fcb18-b2e1-403f-8e54-305df2b2bbcd"
            }
          ]
        },
        {
          "id": "238be5b5-a9e1-4a1e-83a4-c105e5f566ae",
          "name": "BikePoint_Get",
          "request": {
            "url": {
              "protocol": "http",
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "bb3710d7-46ea-49af-953f-127fb841d0d5"
            }
          ]
        }
      ]
    },
    {
      ...
      "item": [
        {
          "id": "478bb236-a410-4a2b-a69c-0851d3d0445a",
          "name": "Cabwise_Get",
          "request": {
          ...
          "response": [
            {
              ...
              "code": 200,
              "name": "Response_200",
              "id": "d354828f-4305-4e67-b4f2-03dfe428227a"
            }
          ]
        }
      ]
